...
![En InputAction med en Up/Down/Left/right composite-binding som döpts till WASD](<../../.gitbook/assets/image (2) (1) (1) (1).png>)
...
Varje InputAction har tre [delegatvariabler](https://app.gitbook.com/s/-MHmNgpRz-b16wpwGwZI-887967055/grundlaggande/delegates) av typen [`Action`](https://krank23.gitbook.io/csharp-ref/grundlaeggande/delegates#h.p\_qt3arehin8yt)`<InputAction.CallbackContext>`. Delegaterna heter **started**, **canceled** och **performed**.
